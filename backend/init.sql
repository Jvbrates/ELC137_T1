...
-- Apagar os tipos ENUM também
DROP TYPE IF EXISTS TIPO_ROLE;
DROP TYPE IF EXISTS TIPO_STATUS_CONTA;
DROP TYPE IF EXISTS TIPO_TRANSACAO;
DROP TYPE IF EXISTS TIPO_CARTAO;
DROP TYPE IF EXISTS TIPO_STATUS_CARTAO;
DROP TYPE IF EXISTS TIPO_STATUS_EMPRESTIMO;
